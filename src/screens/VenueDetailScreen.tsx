...
const getMockVenueDetails = (venueId: string) => {
  const venueDetails: { [key: string]: any } = {
    '1': {
      ...
      rating: 4.5,
      review_count: 127,
      image_url: 'https://via.placeholder.com/400x250/8B4513/FFFFFF?text=Coffee+House',
    ...
    '2': {
      ...
      rating: 4.8,
      review_count: 89,
      image_url: 'https://via.placeholder.com/400x250/FF6347/FFFFFF?text=Sunset+Restaurant',
    ...
    '3': {
      ...
      rating: 4.2,
      review_count: 156,
      image_url: 'https://via.placeholder.com/400x250/32CD32/FFFFFF?text=Urban+Gym',
    ...
    '4': {
      ...
      rating: 4.6,
      review_count: 73,
      image_url: 'https://via.placeholder.com/400x250/8A2BE2/FFFFFF?text=Book+Haven',
    ...
    '5': {
      ...
      rating: 4.3,
      review_count: 201,
      image_url: 'https://via.placeholder.com/400x250/FF4500/FFFFFF?text=Pizza+Corner',
